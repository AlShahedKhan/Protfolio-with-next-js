      ...
      <div className="container-max">
        <div className="mb-14 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div className="space-y-3">
            <span className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-700 dark:text-cyan-300">Selected Work</span>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {selectedProjects.map((project, index) => {
            ...
            return (
              <article
                key={project.id}
                className="group overflow-hidden rounded-[2rem] border border-slate-200 bg-white/85 shadow-[0_30px_80px_rgba(148,163,184,0.16)] transition-all duration-300 hover:-translate-y-1 hover:border-cyan-500/40 dark:border-slate-800 dark:bg-slate-900/70 dark:shadow-[0_30px_80px_rgba(2,6,23,0.28)]"
              >
